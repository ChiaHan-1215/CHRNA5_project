...
write.table(df.out,paste0('~/Desktop/chr15_CHRNA5_bladder_project/lm_analysis/',gsub('_GTEx_.+','',i),'_lm_C5_6isoform_interaction_Never_vs_Current.csv'),quote = F,col.names = T,row.names = F,sep = ',')
rm(df.out)
